...
public class GraphL<V extends Comparable<V>, E extends Comparable<E>> implements IGraph<V, E> {
    ...
    public GraphL(boolean directed, boolean weighted, VertexL<V, E> vertex){
        this.directed = directed;
        this.weighted = weighted;
        vertices = new ArrayList<>();
        edges = new ArrayList<>();
