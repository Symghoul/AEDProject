...
public class GraphLTestDirectedGraph {

    private GraphL<Integer, Integer> directedGraph;
    private GraphL<String, Integer> directedGraph2;

    private void setupScene1(){
        directedGraph = new GraphL<>(true, true, new VertexL<Integer, Integer>(1)); // First vertex (1)
    }
